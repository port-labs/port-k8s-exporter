...
func Init() {
	...
	NewInt(&ApplicationConfig.LiveEventsBulkSyncBatchTimeoutSeconds, "live-events-bulk-sync-batch-timeout-seconds", 2, "Bulk sync batch timeout in seconds. Optional.")
	...
	// Image OS Detection
	NewBool(&ApplicationConfig.ImageOsDetectionEnabled, "image-os-detection-enabled", false, "Enable container image OS detection. Adds .imageOsInfo to K8s object entities. Optional.")
	NewInt(&ApplicationConfig.ImageOsDetectionConcurrency, "image-os-detection-concurrency", 10, "Maximum number of concurrent image OS detections. Optional.")
